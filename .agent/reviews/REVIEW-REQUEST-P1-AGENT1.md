...
| `backend/src/main/java/site/silverbot/api/auth/request/RefreshRequest.java` | 삭제 | 미사용 DTO 제거 |
...
| `frontend/src/features/auth/api/authApi.ts` | 수정 | signup 응답 accessToken 누락 시 에러 처리 |
...
11. allowed-origins 공백 trim으로 CORS 매칭 안정성 개선
12. signup 응답 accessToken 누락 시 에러 throw로 처리 통일
13. 미사용 RefreshRequest DTO 제거
